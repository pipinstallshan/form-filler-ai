    ...
    for idx, html in enumerate(html_snapshots):
        ...
        for tag in snapshot_body.find_all(True):
            for attr in list(tag.attrs):
                if attr not in ['id','name','type','value','for','aria-label','aria-labelledby','aria-required','role','placeholder']:
                    del tag[attr]
...
def main():
    ...
    # url = 'https://job-boards.greenhouse.io/fixify/jobs/4985488008'
    url = 'https://job-boards.greenhouse.io/renttherunway/jobs/7395001'
    # url = 'https://job-boards.greenhouse.io/twilio/jobs/7394811'
